def encrypt_caesar(key: str, text: str) -> str:
    """
    encrypt a text using the caesar algorithm
    :param key: key used
...
def decrypt_caesar(key: str, text: str):
    """
    decrypt a text using the caesar algorithm
    :param key: key used
